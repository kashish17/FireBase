...
public class TvCastAdapter extends RecyclerView.Adapter<CastViewHolder> {

    Context context;
    List<com.example.kashish.movies.TvCastDetils.Cast> lists;
    MovieClickListener movieClickListener;

    TvCastAdapter (Context context, List<com.example.kashish.movies.TvCastDetils.Cast> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final CastViewHolder castViewHolder, int i) {
        com.example.kashish.movies.TvCastDetils.Cast cast= lists.get(i);
