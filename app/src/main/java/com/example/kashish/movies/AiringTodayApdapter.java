...
public class AiringTodayApdapter extends RecyclerView.Adapter<BigMovieViewHolder> {
    Context context;
    List<com.example.kashish.movies.AiringToday.Result> lists;
    MovieClickListener movieClickListener;

    AiringTodayApdapter (Context context, List<com.example.kashish.movies.AiringToday.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final BigMovieViewHolder bigMovieViewHolder, int i) {
        com.example.kashish.movies.AiringToday.Result result = lists.get(i);
