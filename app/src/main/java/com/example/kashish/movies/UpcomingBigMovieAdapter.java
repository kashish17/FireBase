...
import com.example.kashish.movies.nowShowingPOJO.Result;
import com.squareup.picasso.Picasso;

import java.util.List;

public class UpcomingBigMovieAdapter extends RecyclerView.Adapter<BigMovieViewHolder> {

    Context context;
    List<com.example.kashish.movies.UpcomingPOJO.Result> lists;
    MovieClickListener movieClickListener;

    UpcomingBigMovieAdapter (Context context, List<com.example.kashish.movies.UpcomingPOJO.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final BigMovieViewHolder bigMovieViewHolder, int i) {
        com.example.kashish.movies.UpcomingPOJO.Result result = lists.get(i);
        ...
        String url = Contract.IMAGE_URL + result.getBackdropPath();
        ...
        bigMovieViewHolder.textView.setText(result.getTitle());
