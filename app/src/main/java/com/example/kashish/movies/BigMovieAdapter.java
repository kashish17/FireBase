...
public class BigMovieAdapter extends RecyclerView.Adapter<BigMovieViewHolder> {
    Context context;
    List<com.example.kashish.movies.nowShowingPOJO.Result> lists;
    MovieClickListener movieClickListener;

    BigMovieAdapter (Context context, List<com.example.kashish.movies.nowShowingPOJO.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final BigMovieViewHolder bigMovieViewHolder, int i) {
        ...
        com.example.kashish.movies.nowShowingPOJO.Result result = lists.get(i);
