...
import com.example.kashish.movies.SimilarMovies.Result;
import com.squareup.picasso.Picasso;

import java.util.List;

public class SimilarShowsAdapter extends RecyclerView.Adapter<MovieViewHolder> {

    Context context;
    List<com.example.kashish.movies.SimilarTvShows.Result> lists;
    MovieClickListener movieClickListener;

    SimilarShowsAdapter (Context context, List<com.example.kashish.movies.SimilarTvShows.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, int i) {
        com.example.kashish.movies.SimilarTvShows.Result result = lists.get(i);
        ...
        movieViewHolder.textView.setText(result.getName());
