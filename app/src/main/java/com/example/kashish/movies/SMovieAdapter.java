...
public class SMovieAdapter extends RecyclerView.Adapter<MovieViewHolder> {
    Context context;
    List<com.example.kashish.movies.SimilarMovies.Result> lists;
    MovieClickListener movieClickListener;

    SMovieAdapter (Context context, List<com.example.kashish.movies.SimilarMovies.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, int i) {
        com.example.kashish.movies.SimilarMovies.Result result = lists.get(i);
