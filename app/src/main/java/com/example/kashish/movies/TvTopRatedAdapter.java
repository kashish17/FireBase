...
import com.example.kashish.movies.TVPopular.Result;
import com.squareup.picasso.Picasso;

import java.util.List;

public class TvTopRatedAdapter extends RecyclerView.Adapter<MovieViewHolder> {
    Context context;
    List<com.example.kashish.movies.TvTopRated.Result> lists;
    MovieClickListener movieClickListener;

    TvTopRatedAdapter (Context context, List<com.example.kashish.movies.TvTopRated.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, int i) {
        com.example.kashish.movies.TvTopRated.Result result = lists.get(i);
