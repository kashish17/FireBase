...
import com.example.kashish.movies.Trailers.Result;
import com.squareup.picasso.Picasso;

import java.util.List;

public class TvTrailersAdapter extends RecyclerView.Adapter<BigMovieViewHolder> {
    Context context;
    List<com.example.kashish.movies.TvTrailers.Result> lists;
    MovieClickListener movieClickListener;

    TvTrailersAdapter (Context context, List<com.example.kashish.movies.TvTrailers.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final BigMovieViewHolder bigMovieViewHolder, int i) {
        com.example.kashish.movies.TvTrailers.Result result = lists.get(i);
