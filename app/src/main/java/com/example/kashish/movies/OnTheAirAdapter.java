...
public class OnTheAirAdapter extends RecyclerView.Adapter<BigMovieViewHolder> {

    Context context;
    List<com.example.kashish.movies.TV.TVOnTheAir.Result> lists;
    MovieClickListener movieClickListener;

   OnTheAirAdapter (Context context, List<com.example.kashish.movies.TV.TVOnTheAir.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final BigMovieViewHolder bigMovieViewHolder, int i) {
        com.example.kashish.movies.TV.TVOnTheAir.Result result = lists.get(i);
