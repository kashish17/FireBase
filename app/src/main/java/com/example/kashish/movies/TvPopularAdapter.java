...
public class TvPopularAdapter extends RecyclerView.Adapter<MovieViewHolder> {

    Context context;
    List<com.example.kashish.movies.TVPopular.Result> lists;
    MovieClickListener movieClickListener;

 TvPopularAdapter (Context context, List<com.example.kashish.movies.TVPopular.Result> lists, MovieClickListener movieClickListener){
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, int i) {
        ...
        com.example.kashish.movies.TVPopular.Result result = lists.get(i);
